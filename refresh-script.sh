...
export UPLINK_WRITE=YOUR_UPLINK_WRITE_KEY
...
#uplink cp --access uploaderbot  sj://pocket-public-blockchains/$name sj://pocket-public-blockchains/pocket-network-data-RC-0.6.3.6.tar --config-dir /root/.local/share/storj/uplink
