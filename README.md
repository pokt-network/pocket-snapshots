...
[Compressed](https://link.us1.storjshare.io/raw/jwyeczocniszw2ft7dhs7ie3xe2q/pocket-public-blockchains/pocket-network-data-1218-rc-0.6.3.6.tar.gz)

[Tar](https://link.us1.storjshare.io/raw/jxexitdsngkomnq7txacvde2nraq/pocket-public-blockchains/pocket-network-data-1218-rc-0.6.3.6.tar)
...
wget -qO- https://link.us1.storjshare.io/raw/jxexitdsngkomnq7txacvde2nraq/pocket-public-blockchains/pocket-network-data-1218-rc-0.6.3.6.tar | tar xvf -
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-1218-rc-0.6.3.6.tar ./pocket.tar --parallelism 5
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-1218-rc-0.6.3.6.tar.gz ./pocket.tar.gz --parallelism 5
...
wget -O pocket.tar.gz https://link.us1.storjshare.io/raw/jwyeczocniszw2ft7dhs7ie3xe2q/pocket-public-blockchains/pocket-network-data-1218-rc-0.6.3.6.tar.gz
...
wget -O pocket.tar https://link.us1.storjshare.io/raw/jxexitdsngkomnq7txacvde2nraq/pocket-public-blockchains/pocket-network-data-1218-rc-0.6.3.6.tar
...
time rclone copy --progress --s3-upload-concurrency 32 --s3-chunk-size 256M  downloader:pocket-public-blockchains/pocket-network-data-1218-rc-0.6.3.6.tar ./
