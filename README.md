...
[Compressed](https://link.us1.storjshare.io/raw/julpy5mcx7jvtdpym5tnxjk45uaa/pocket-public-blockchains/pocket-network-data-0023-rc-0.6.3.6.tar.gz)

[Tar](https://link.us1.storjshare.io/raw/jwbmy43m23dbv32f3lgebd4oxh4q/pocket-public-blockchains/pocket-network-data-0023-rc-0.6.3.6.tar)
...
wget -qO- https://link.us1.storjshare.io/raw/jwbmy43m23dbv32f3lgebd4oxh4q/pocket-public-blockchains/pocket-network-data-0023-rc-0.6.3.6.tar | tar xvf -
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-0023-rc-0.6.3.6.tar ./pocket.tar --parallelism 5
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-0023-rc-0.6.3.6.tar.gz ./pocket.tar.gz --parallelism 5
...
wget -O pocket.tar.gz https://link.us1.storjshare.io/raw/julpy5mcx7jvtdpym5tnxjk45uaa/pocket-public-blockchains/pocket-network-data-0023-rc-0.6.3.6.tar.gz
...
wget -O pocket.tar https://link.us1.storjshare.io/raw/jwbmy43m23dbv32f3lgebd4oxh4q/pocket-public-blockchains/pocket-network-data-0023-rc-0.6.3.6.tar
