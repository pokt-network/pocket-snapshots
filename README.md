...
[Compressed](https://link.us1.storjshare.io/raw/jvxxeysobrie6xblrqs3wbp2q7hq/pocket-public-blockchains/pocket-network-data-1226-rc-0.6.3.6.tar.gz)

[Tar](https://link.us1.storjshare.io/raw/jxvayxku3jodnnkli3xgksuia63a/pocket-public-blockchains/pocket-network-data-1226-rc-0.6.3.6.tar)
...
wget -qO- https://link.us1.storjshare.io/raw/jxvayxku3jodnnkli3xgksuia63a/pocket-public-blockchains/pocket-network-data-1226-rc-0.6.3.6.tar | tar xvf -
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-1226-rc-0.6.3.6.tar ./pocket.tar --parallelism 5
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-1226-rc-0.6.3.6.tar.gz ./pocket.tar.gz --parallelism 5
...
wget -O pocket.tar.gz https://link.us1.storjshare.io/raw/jvxxeysobrie6xblrqs3wbp2q7hq/pocket-public-blockchains/pocket-network-data-1226-rc-0.6.3.6.tar.gz
...
wget -O pocket.tar https://link.us1.storjshare.io/raw/jxvayxku3jodnnkli3xgksuia63a/pocket-public-blockchains/pocket-network-data-1226-rc-0.6.3.6.tar
