...
[Compressed](https://link.us1.storjshare.io/raw/jw2zrekkl5f55krdcmxedg2diftq/pocket-public-blockchains/pocket-network-data-0016-rc-0.6.3.6.tar.gz)

[Tar](https://link.us1.storjshare.io/raw/jxtl2bz3paws4v6pkrw7czqftvlq/pocket-public-blockchains/pocket-network-data-0016-rc-0.6.3.6.tar)
...
wget -qO- https://link.us1.storjshare.io/raw/jxtl2bz3paws4v6pkrw7czqftvlq/pocket-public-blockchains/pocket-network-data-0016-rc-0.6.3.6.tar | tar xvf -
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-0016-rc-0.6.3.6.tar ./pocket.tar --parallelism 5
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-0016-rc-0.6.3.6.tar.gz ./pocket.tar.gz --parallelism 5
...
wget -O pocket.tar.gz https://link.us1.storjshare.io/raw/jw2zrekkl5f55krdcmxedg2diftq/pocket-public-blockchains/pocket-network-data-0016-rc-0.6.3.6.tar.gz
...
wget -O pocket.tar https://link.us1.storjshare.io/raw/jxtl2bz3paws4v6pkrw7czqftvlq/pocket-public-blockchains/pocket-network-data-0016-rc-0.6.3.6.tar
...
time rclone copy --progress --s3-upload-concurrency 32 --s3-chunk-size 256M  downloader:pocket-public-blockchains/pocket-network-data-0016-rc-0.6.3.6.tar ./
