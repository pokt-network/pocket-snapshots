...
[Compressed](https://link.us1.storjshare.io/raw/juayprjyjldok3kzikpvwa2azara/pocket-public-blockchains/pocket-network-data-0001-rc-0.6.3.6.tar.gz)

[Tar](https://link.us1.storjshare.io/raw/jvsjx4pmefc7rv2hc2h7vsu54q7a/pocket-public-blockchains/pocket-network-data-0001-rc-0.6.3.6.tar)
...
wget -qO- https://link.us1.storjshare.io/raw/jvsjx4pmefc7rv2hc2h7vsu54q7a/pocket-public-blockchains/pocket-network-data-0001-rc-0.6.3.6.tar | tar xvf -
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-0001-rc-0.6.3.6.tar ./pocket.tar --parallelism 5
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-0001-rc-0.6.3.6.tar.gz ./pocket.tar.gz --parallelism 5
...
wget -O pocket.tar.gz https://link.us1.storjshare.io/raw/juayprjyjldok3kzikpvwa2azara/pocket-public-blockchains/pocket-network-data-0001-rc-0.6.3.6.tar.gz
...
wget -O pocket.tar https://link.us1.storjshare.io/raw/jvsjx4pmefc7rv2hc2h7vsu54q7a/pocket-public-blockchains/pocket-network-data-0001-rc-0.6.3.6.tar
