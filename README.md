...
[Compressed](https://link.us1.storjshare.io/raw/jv4pkdwrgio2ayrhb5lvceoh6puq/pocket-public-blockchains/pocket-network-data-0030-rc-0.6.3.6.tar.gz)

[Tar](https://link.us1.storjshare.io/raw/jvs6mmbgtcouw3r2d6w7ktdaohrq/pocket-public-blockchains/pocket-network-data-0030-rc-0.6.3.6.tar)
...
wget -qO- https://link.us1.storjshare.io/raw/jvs6mmbgtcouw3r2d6w7ktdaohrq/pocket-public-blockchains/pocket-network-data-0030-rc-0.6.3.6.tar | tar xvf -
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-0030-rc-0.6.3.6.tar ./pocket.tar --parallelism 5
...
```bash
uplink --access $UPLINK_DOWN cp sj://pocket-public-blockchains/pocket-network-data-0030-rc-0.6.3.6.tar.gz ./pocket.tar.gz --parallelism 5
...
wget -O pocket.tar.gz https://link.us1.storjshare.io/raw/jv4pkdwrgio2ayrhb5lvceoh6puq/pocket-public-blockchains/pocket-network-data-0030-rc-0.6.3.6.tar.gz
...
wget -O pocket.tar https://link.us1.storjshare.io/raw/jvs6mmbgtcouw3r2d6w7ktdaohrq/pocket-public-blockchains/pocket-network-data-0030-rc-0.6.3.6.tar
